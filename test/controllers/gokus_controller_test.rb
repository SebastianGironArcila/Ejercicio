...
class GokusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create goku" do
    assert_difference('Goku.count') do
      post gokus_url, params: { goku: { descripcion: @goku.descripcion, nombre: @goku.nombre, precio: @goku.precio } }
    end
  ...
  test "should update goku" do
    patch goku_url(@goku), params: { goku: { descripcion: @goku.descripcion, nombre: @goku.nombre, precio: @goku.precio } }
